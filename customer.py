...
class Cust_Win:
    def __init__(self,root):
        ...
        txtpostcode=ttk.Entry(labelframeleft,textvariable=self.var_post,width=29,font=("arial",12,"bold"))
        ...
        #Nationality
        lblNationality=Label(labelframeleft,text="Post Code:",font=("arial",12,"bold"),padx=2,pady=6)
        ...
        combo_Nationality["value"]=("Indian","Russian","Corien","American","Nepal","Chinese")
        combo_Nationality.current(0)
        combo_Nationality.grid(row=7,column=1)


        #id proof
        lblIdProof=Label(labelframeleft,text="Post Code:",font=("arial",12,"bold"),padx=2,pady=6)
        lblIdProof.grid(row=8,column=0,sticky=W)
        combo_Id=ttk.Combobox(labelframeleft,textvariable=self.var_idproof,font=("arial",12,"bold"),width=27,state="readonly")
        combo_Id["value"]=("Aadhaar Card","Pan Card","Passport")
        combo_Id.current(0)
    ...
    def update(self):
        if self.var_mobile.get()=="":
            ...
            self.fetch_data()
            conn.close()
            messagebox.showinfo("Update","Customer details has bees updated successfully",parent=self.root)
