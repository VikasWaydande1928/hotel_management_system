...
class DetailsRoom:
    def __init__(self,root):
        ...
        entry_RoomNo.grid(row=1,column=1,sticky=W,padx=20)


        #Room Type
        lbl_RoomType=Label(labelframeleft,text="Room Type:",font=("arial",12,"bold"),padx=2,pady=6)
        lbl_RoomType.grid(row=2,column=0,padx=20)
        ...
        Table_Frame=LabelFrame(self.root,bd=2,relief=RIDGE,text="Show Room Details",font=("arial",12,"bold"),fg="black",width=9)
    ...
    def update(self):
            if self.var_floor.get()=="":
                ...
                self.fetch_data()
                conn.close()
                messagebox.showinfo("Update","New Room details has bees updated successfully",parent=self.root)
